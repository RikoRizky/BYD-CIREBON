      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 py-20 lg:py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="rounded-3xl border border-white/10 bg-gradient-to-r from-black/40 to-black/10 p-6 shadow-lg shadow-black/30 hover:transform hover:scale-105 transition-all duration-300"
            >
